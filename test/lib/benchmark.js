...
console.log("Benchmarking Vap-Lib's RLP implementation vs the one on NPM.");
...
console.log("- Vap-Lib: " + liteCps + " calls per second.");
console.log("- Reference: " + npmCps + " calls per second.");
console.log("- Vap-Lib is: " + (liteCps / npmCps).toFixed(2) + " " + (liteCps > npmCps ? "faster" : "slower") + " than reference.");
